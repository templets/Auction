...
var clientId = process.env.SINGLY_CLIENT_ID || 'lockbox';
var clientSecret = process.env.SINGLY_CLIENT_SECRET || 'hemlis';

var hostBaseUrl = (process.env.HOST || 'http://localhost:' + port);
var apiBaseUrl = (process.env.SINGLY_API_HOST || 'http://localhost:8042');
